...
map('n', '<leader>fa', ':Telescope find_files search_dir={~},--hidden<CR>', { desc = 'Telescope find all files from home directory' })
...
map({ 'n', 'v' }, '<leader>dr', ":lua require('dapui').open({reset = true})<CR>", { noremap = true, desc = 'Reload debugger UI' })
